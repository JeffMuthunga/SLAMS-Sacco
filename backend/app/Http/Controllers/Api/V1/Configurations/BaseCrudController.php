...
abstract class BaseCrudController extends ApiController
{
    ...
    {
        $items = app($this->modelClass())::where('org_id', $request->user()->org_id)->get();
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        $item = app($this->modelClass())::create($data);
        $resourceClass = $this->resourceClass();
    ...
    {
        $item = app($this->modelClass())::where('org_id', $request->user()->org_id)->findOrFail($id);
        $resourceClass = $this->resourceClass();
    ...
    public function update(Request $request, string $id): JsonResponse
    {
        ...
        $item = app($this->modelClass())::where('org_id', $orgId)->findOrFail($id);
