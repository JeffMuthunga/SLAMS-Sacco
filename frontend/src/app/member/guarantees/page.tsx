...
export default function GuaranteesPage() {
  ...
  const { data, isLoading, error } = useMemberGuarantees({ status: status || undefined, per_page: 50 });

  return (
    <div className="flex flex-col gap-6">
      <h1 className="text-2xl font-semibold text-dark dark:text-white">My Guarantees</h1>
